        ...
        var publicMethods = {
          ...
          open: function (opts) {
            ...
            $q.when(loadTemplate(options.template || options.templateUrl)).then(function (template) {
              ...
              var typeClass=options.type?" ngdialog-content-"+options.type:"";
              $dialog.html((options.overlay ?
                '<div class="ngdialog-overlay"></div><div class="ngdialog-content'+typeClass+'" role="document">' + template + '</div>' :
                '<div class="ngdialog-content'+typeClass+'" role="document">' + template + '</div>'));
