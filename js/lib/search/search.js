...
function bmSearch(){
    ...
    self.vars = {
        ...
        googleKey: '017156821116155704347:e0grp0gsys4',          //API key used by google search JS file
        page: 'search'
    };
    
    /* Check if we are on spanish, use that API key in stead */
    if(window.location.host === 'espanol.boostmobile.com' || urlParams.lang === 'es'){
        self.vars.googleKey = '017156821116155704347:9vyxq0md_-e';
    }
